...
class DatalistExtension extends \Twig_Extension implements ContainerAwareInterface
{
    ...
    public function getFunctions()
    {
        return array(
            ...
            'datalist_searchform' => new \Twig_Function_Method($this, 'renderDatalistSearchform', array('is_safe' => array('html')))
        );
    }
     ...
     * @return string
     */
    public function renderDatalistSearchform(DatalistInterface $datalist)
    {
        $blockName = 'datalist_searchform';
